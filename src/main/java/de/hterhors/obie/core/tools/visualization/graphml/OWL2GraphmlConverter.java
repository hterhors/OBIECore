...
import de.hterhors.obie.core.tools.visualization.graphml.templates.ClassWithDataTypeProperties;
import de.hterhors.obie.core.tools.visualization.graphml.templates.ClassWithOutDataTypeProperties;
import de.hterhors.obie.core.tools.visualization.graphml.templates.DataTypeClass;
import de.hterhors.obie.core.tools.visualization.graphml.templates.GroupNodes;
...
import de.hterhors.obie.core.tools.visualization.graphml.templates.ObjectTypePropertyEdge;
import de.hterhors.obie.core.tools.visualization.graphml.templates.SubClassEdge;
...
public class OWL2GraphmlConverter {
	...
	protected OWLReader dataProvider = new OWLReader(env);
