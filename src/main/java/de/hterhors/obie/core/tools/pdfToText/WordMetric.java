...
public class WordMetric {
	...
	public static void main(String[] args) {
		...
		levenshteinDistance(
				"asgaSDHADGSKMNBVDSFDJLKÖGKLHKBDGSFHAKGLKDMZNSG<DBVasdhasdtjdfjafdhögböoisdbgp94thgdisgh<yoshg843KMNBVDSFDJLKÖGKLHKBD",
				"dgjbq8723qtbpnvy<98vh4gsdiögböoisdbgp94thgdisgh<yoshg843KMNBVDSFDJLKÖGKLHKBDGSFHAKGLKDMZNSG<DBVasKBDGSFHAKGLKDMZNSG<DBVasdhasdtjdfjafdhögböoisdbgp94thgdisgh<yoshg843KMNBV");

		long t2 = System.currentTimeMillis();
		System.out.println(t2 - t1);
	}

	public static double levenshteinSimilarity(final String a, final String b) {
	 ...
	 * @return
	 */
	public static double levenshteinSimilarity2(final String a, final String b) {
		final int max = Math.max(a.length(), b.length());
		double d = levenshteinDistance(a, b);
